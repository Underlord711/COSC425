/*
 *  Name:           ModAntho_Alg.cpp (Anthony's Iteration Algorithm V1, moddified by Jase)
...
extern "C" {
	...
	tuple<tuple<char, float>, tuple<char, float>, float>
	relation_eval(const tuple<tuple<char, float>, tuple<char, float>, float> rel)
	{
		// Access each node
